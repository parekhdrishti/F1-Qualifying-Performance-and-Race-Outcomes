...
st.title("🏎️ F1 Qualifying vs Race Outcomes Dashboard")
st.write("Analysis of qualifying position vs race finish from 2000–2024.")


with st.expander("About this dashboard"):
    st.write(
        "This dashboard analyzes how qualifying position relates to race finish in Formula 1 from 2000 to 2024. "
        "The dataset was cleaned by merging race and qualifying data, removing DNFs, and creating derived variables "
...
with tab1:
    ...
    st.write(
        ...
        "The trend line helps highlight the overall positive relationship, while team-color mode is useful for comparing constructors."
    )
...
with tab2:
    ...
    st.write(
        "Most drivers finish close to where they started. Large gains or losses happen less often."
    )
    ...
    st.write(
        "This boxplot compares how many positions drivers gain or lose depending on where they started. "
...
with tab4:
    ...
    st.write(
        "These descriptive statistics summarize the distributions of qualifying position, finish position, "
    ...
    st.write(
        "This section compares how strongly qualifying predicts race finish across different Formula 1 eras."
    )
    ...
    st.write(
        "A very small p-value would indicate that podium outcomes depend strongly on starting grid group."
    )

    #Limitations note
    st.info(
    "Note: This analysis excludes DNFs and incomplete records, so the results describe finishing outcomes "
